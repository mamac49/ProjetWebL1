...
<?php
echo "<script src='Location : https://mlanglois.freeboxos.fr/Projetwebl1/ENT/js/main.js''></script>";
if ($_SESSION['theme'] == 1) {
  echo "<script>LoadCSS('Location : https://mlanglois.freeboxos.fr/Projetwebl1/ENT/css/color1.css''); </script>";
} else {
  echo "<script>LoadCSS('Location : https://mlanglois.freeboxos.fr/Projetwebl1/ENT/css/color2.css''); </script>";
}
?>
...
<div class="site_container">
  ...
  <nav class="sandwich" id="menu_sandwich">
    ...
    <ul class="menuAutre">
      ...
      ?>
      <li><a class="menu_link" onclick="LoadCSS('Location: Location : https://mlanglois.freeboxos.fr/Projetwebl1/ENT/css/color1.css')'><div class="pointer"><i class="fas fa-moon icone"></i>Theme Sombre</div></a></li>
      <li><a class="menu_link" onclick="LoadCSS('Location: Location : https://mlanglois.freeboxos.fr/Projetwebl1/ENT/css/color2.css'')"><div class="pointer"><i class="fas fa-sun icone"></i>Theme Clair</div></a></li>
