...
<div class="site_container">
  ...
  <nav class="burger" id="menu_burger">
    ...
    <ul class="menuAutre">
      ...
      ?>
      <li><a class="menu_link" onclick="LoadCSS('/Projetwebl1/ENT/css/color1.css')"><div class="texteBurger"><i class="fas fa-moon icone"></i>Theme Sombre</div></a></li>
      <li><a class="menu_link" onclick="LoadCSS('/Projetwebl1/ENT/css/color2.css')"><div class="texteBurger"><i class="fas fa-sun icone"></i>Theme Clair</div></a></li>
