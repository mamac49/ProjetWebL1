        ...
        ?>
          <li class="contact">
            <div class="infos_basiques">
              ...
              <button class="infos_button" onclick="copy(<?php echo $x[0]; ?>)"><i class="fas fa-envelope"></i>
                </button>
                <textarea id="<?php echo 'ToCopy' . $x[0]; ?>" style="display: 'none'"><?php echo $mail; ?></textarea>
                <!--<div class="fin">-->
