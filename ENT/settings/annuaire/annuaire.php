    ...
    <div class="site_container">
      <script src="annuaire.js"></script>
          <div class="Center_adap">
            ...
            ?>
              <li class="contact">
                <div class="debut"><a class="<?php echo $contact_id;?> texte" id="contact"><span><img src="<?php echo ' data:image/png;base64,' . base64_encode(Affichage($mail)) . ' '?>" alt="Photo de profil" class="PPannuaire"><span class="midContact"><?php echo $contact_name;?></span></span></a></div>
                <div class="fin">
