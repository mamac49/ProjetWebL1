      ...
      <ul>
        <?php $x=0;
          foreach (nombreAvisUser() as $id) { ?>
            <li class="texte suppression"><?php echo AfficheAvis($id[0][0])[0];?><span style="display: none" id=<?php print "more-". $x ?>><?php echo AfficheAvis($id[0][0])[1];?></span><a href="<?php print "SupAvis.php?id=" . $id[0][0];?>">
