      ...
      <ul>
        <?php $x=0;
          foreach (nombreAvisUser() as $id) { ?>
            <li class="texte suppression"><div class="avis"><?php echo AfficheAvis($id[0][0])[0];?><span style="display: none" id=<?php print "more-". $x ?>><?php echo AfficheAvis($id[0][0])[1];?></span></div>
