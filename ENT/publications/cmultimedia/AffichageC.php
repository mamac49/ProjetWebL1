          ...
          foreach (AffichageCahier($IDcahier) as $line) {
            if (substr_count($line, "http") == 1) {
              if (substr_count($line, "https://www.deezer.com/") == 1) {
                ...
                echo "<iframe title='deezer-widget' src='https://widget.deezer.com/widget/dark/track/'. $track .'?tracklist=false' width='300px' height='150px' frameborder='0' allowtransparency='true' allow='encrypted-media; clipboard-write'></iframe>";
              } else {
