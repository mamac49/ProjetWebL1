  ...
  <head>
    ...
    ?>
          ...
          <div class="Center">
            ...
            ?>
            <form>
              <input type="button" class="boutonanime" onclick="window.location.href = 'creationB.php';" name="CreationBlog" value="Créer Un Blog"/>
              <select name="BlogD">
                <?php
              foreach (nbPub() as $x){
                  if (nature($x[0]) == "1") {
              ...
              <input type="submit" name="ValiderSupp" value="Supprimer le blog" class="boutonanime">
              <br/>
            </form>
            <?php
            }
